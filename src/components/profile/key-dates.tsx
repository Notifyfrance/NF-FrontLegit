...
export function KeyDates({ keyDates, memberSince }: KeyDatesProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div className="bg-bg-darker rounded-xl p-4 border-l-4 border-badge-1">
        <div className="flex items-center gap-2 mb-2">
          <Calendar className="w-4 h-4 text-badge-1" />
      ...
      <div className="bg-bg-darker rounded-xl p-4 border-l-4 border-badge-5">
        <div className="flex items-center gap-2 mb-2">
          <Clock className="w-4 h-4 text-badge-5" />
      ...
      <div className="bg-bg-darker rounded-xl p-4 border-l-4 border-primary">
        <div className="flex items-center gap-2 mb-2">
